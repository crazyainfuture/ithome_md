...
![image](https://hackmd.io/_uploads/HJAWaD9Ozl.png)
...
![image](https://hackmd.io/_uploads/Bytq0v5uGl.png)

---
![image](https://hackmd.io/_uploads/ByBjAwcOzg.png)

當發現發生錯誤時，工程師會立刻來到這區，檢視 observation（使用者的原始問題）和 action（Agent 的回答）。藉此判斷是「Prompt 沒寫好」、「模型真的笨」，還是「外部工具的格式改版導致解析失敗」。

---
### 實驗發送的問題
![image](https://hackmd.io/_uploads/rkj3ADq_Gx.png)

![image](https://hackmd.io/_uploads/B1PZJucdGx.png)
...
這次我們連續問10個問題
![image](https://hackmd.io/_uploads/BkJ4kdcdzx.png)

![image](https://hackmd.io/_uploads/SyrNkd9ufg.png)
